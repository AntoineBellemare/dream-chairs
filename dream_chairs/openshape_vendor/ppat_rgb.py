# Vendored verbatim from OpenShape (Apache-2.0):
#   https://huggingface.co/OpenShape/openshape-demo-support  (openshape/ppat_rgb.py)
# Point Patch Aggregation Transformer (PPAT) used by the OpenShape point encoders.
import torch
